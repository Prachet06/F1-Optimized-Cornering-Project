...
# TODO: Ensure lap screenshot names are rewritten and screenshots are pasted into a new directory, maybe write the path of each ss along with its name
# TODO: Check what happens when a brake or throttle is crash causing or tl violating and only has braking
# TODO: Investigate why later laps repeat in the collated list when printing from line 107
